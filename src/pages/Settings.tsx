...
import {
  PROMPT_USER_RESTART, GET_BLOCKTIME, SET_LOCAL_TERRA_PATH, RESET_APP,
} from '../constants';
    ...
    >
      <div className="relative w-full h-full">
        <div className="relative bg-white h-full rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex items-center p-6 space-x-3 rounded-b border-t border-gray-200 dark:border-gray-600">
            <button
              data-modal-toggle="top-left-modal"
              type="button"
